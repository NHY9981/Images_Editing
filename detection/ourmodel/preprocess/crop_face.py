...
if __name__ == '__main__':
    ...
    VIDEO_ROOT = '/root/autodl-tmp/Celeb-DF-v2'          # The base dir of CelebDF-v2 dataset
    OUTPUT_PATH = '/root/autodl-tmp/Celeb-DF-v2-crop/'    # Where to save cropped training faces
    TXT_PATH = "/root/our_model/train-list.txt"    # the given train-list.txt file
    ...
    for line in tqdm(data, desc="Processing videos"):  # 添加tqdm进度条
        video_name = line[2:-1]
